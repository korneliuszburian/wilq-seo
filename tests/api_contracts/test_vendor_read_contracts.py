    ...
    assert result.metric_facts == [
        VendorMetricFact(
            ...
            7,
            {
                ...
                "target_competitor_sample_size": "1",
                "target_competitor_limit": "10",
                "keywords_common": "8",
                "keywords_competitor": "42",
                "keywords_target": "12",
                "share": "0.17",
...
def test_wordpress_vendor_read_uses_rest_content_inventory(
    ...
    assert result.metric_summary == {
        ...
        "sitemap_coverage_status": "complete",
        "public_sitemap_coverage_status": "not_applicable",
