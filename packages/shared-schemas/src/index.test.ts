...
describe("ContentEditorialIntegrityReportSchema", () => {
  it("keeps an editorial report bound to exact immutable revisions", () => {
    const report = {
      work_item_id: "content_work_item_bdo",
      baseline_revision: { revision_id: "content_revision_r8", content_digest: "a".repeat(64), revision_number: 8 },
      direct_parent_revision: { revision_id: "content_revision_r10", content_digest: "b".repeat(64), revision_number: 10 },
      child_revision: { revision_id: "content_revision_r11", content_digest: "c".repeat(64), revision_number: 11 },
      ...
      human_readable_diff: "Niezmienniki struktury naruszone: 0.", result: "integrity_ok"
    };
