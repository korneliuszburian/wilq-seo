export const ahrefsDiagnostics = {
  ...
  data_readiness: {
    ...
    reason: "WILQ potwierdził wyłącznie zakończone etapy odczytu Ahrefs.",
    safe_next_step: "Sprawdź pełny odczyt Ahrefs przed wykorzystaniem luk w decyzji.",
    connector_id: "ahrefs",
    ...
    factual_metrics: [
      {
        ...
        period_label: "odczyt domeny Ahrefs",
    ...
    coverage_label: "Pokazane fakty obejmują tylko zakończone etapy odczytu Ahrefs.",
