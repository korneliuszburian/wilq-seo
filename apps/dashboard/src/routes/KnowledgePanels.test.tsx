        ...
        map={
          {
            ...
            blocked_claim_count_summary_label: "WILQ nie zgłosił zablokowanych obietnic; nadal sprawdź dowody przed publikacją",
            bindings: [
              {
                ...
                blocked_claim_summary_label: "WILQ nie zgłosił zakazanych obietnic; nadal sprawdź dowody przed publikacją",
                blocked_claim_count_summary_label: "WILQ nie zgłosił zablokowanych obietnic; nadal sprawdź dowody przed publikacją",
