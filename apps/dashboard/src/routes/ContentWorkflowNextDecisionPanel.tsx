  ...
  return (
    <div className="rounded-md border border-line bg-surface p-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h3 className="text-sm font-semibold uppercase tracking-normal text-slate-700">Następna decyzja operatora</h3>
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        <a className="inline-flex items-center rounded-md bg-action px-4 py-2 text-sm font-semibold text-white" href="#content-workflow-actions">Przejdź do decyzji operatora</a>
        <a className="inline-flex items-center rounded-md border border-action/40 px-4 py-2 text-sm font-semibold text-action" href="#content-workflow-proof">Pokaż dowody</a>
      </div>
    </div>
  );
}
