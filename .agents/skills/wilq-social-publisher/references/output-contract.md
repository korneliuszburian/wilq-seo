...
Oczekiwany wynik: propozycje postów social z source evidence, stanem review i blockerami connectorów.

## Wymagany kontekst API

Pobierz `POST /api/codex/context-pack` z
`{"skill":"wilq-social-publisher"}` przed analizą marketingową. Skillowy
context-pack musi zawierać `social_draft_context`; traktuj go jako kontrakt
