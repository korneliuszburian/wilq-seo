...
8. Dla pytań o aktualny stan feedu użyj `freshness_assessment`: `requires_refresh=true` albo `state=stale|missing|blocked` oznacza nieaktualne dane albo blokadę, chyba że użytkownik jawnie pozwala na odczyt danych źródła danych.
