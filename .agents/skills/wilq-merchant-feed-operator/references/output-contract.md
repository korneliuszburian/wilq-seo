...
4. `Przykładowe produkty`: jeśli `product_sample_gotowość.sample_products_available=true`, pokaż kilka `sample_product_ids` albo tytułów jako materiał do sprawdzenia. Nie traktuj próbek jako pełnej listy SKU ani zgody na zapis do pliku produktowego.
