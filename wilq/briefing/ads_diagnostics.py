...
def _ads_freshness_assessment(
    ...
    completed_at = _as_utc(latest_refresh.completed_at or latest_refresh.started_at)
    ...
    if not connector_refresh_has_live_data(latest_refresh):
        return AdsFreshnessAssessment(
            ...
            summary=(
                ...
                f"Status odczytu: {_ads_refresh_status_label(latest_refresh)}."
            ),
            next_step=(
...
def _business_context_contract_state(
    *,
...
def _business_context_read_contract(
    ...
    (
        ...
        target_missing,
        status,
    ) = _business_context_contract_state(
        profit_margin=profit_margin,
        business_goal=business_goal,
        budget_goal=budget_goal,
        target_roas=target_roas,
