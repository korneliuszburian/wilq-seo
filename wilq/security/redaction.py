...
SAFE_OPAQUE_IDENTIFIER_KEYS = {
    ...
    "trusted_local_principal_receipt_id",
...
SAFE_IDENTIFIER_KEYS = {
    ...
    "expected_classification_run_digest",
    "expected_decision_set_digest",
    "expected_source_packet_row_digest",
    "decision_set_digest",
