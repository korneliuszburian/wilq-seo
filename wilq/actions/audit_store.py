...
def action_mutation_audit_record(
    *,
    ...
    return ActionMutationAuditRecord(
        ...
        submitted_actor_label=audit_event.submitted_actor_label,
...
def build_impact_check_audit_event(
    *,
    action: ActionObject,
    actor: str,
    event_type: str,
    ...
    """Build the measurement impact-check event with explicit evidence lineage."""
    return AuditEvent(
