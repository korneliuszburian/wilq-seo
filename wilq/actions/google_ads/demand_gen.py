...
def demand_gen_readiness_action_from_metric_facts(
    ...
    *,
    ...
    evidence_ids = unique_values(
        [
            ...
            *latest_google_ads_evidence_ids,
            *latest_ga4_evidence_ids,
    ...
    demand_gen_ad_group_ad_rows = demand_gen_ad_group_ad_rows_from_facts(google_ads_facts)
    demand_gen_creative_asset_rows = demand_gen_creative_asset_rows_from_facts(google_ads_facts)
    demand_gen_landing_quality_rows = demand_gen_landing_quality_rows_from_facts(
        ga4_facts, demand_gen_rows
    )
...
def latest_vendor_read_evidence_ids(connector_id: str) -> list[str]:
