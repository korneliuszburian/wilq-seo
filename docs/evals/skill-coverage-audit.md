...
| `wilq-content-strategist` | `.local-lab/evals/codex-skill/20260624T075942Z/wilq-content-strategist/result.json` | 5 | ready / brief-quality checked | Uses `content_diagnostics.decision_queue`, freshness, BDO/Zielony Ład decisions and compacted `content_brief_preview_v1` fields for angle, audience, objections, source facts, missing evidence and forbidden claims. | Still review-only: no publish-ready final copy or WordPress write without inventory/canonical checks, review and audit. |
