...
| Service Profile | `production` | `demo_ready` | 10 | 0 | 0 | 1 | 14 | 41 | Przejrzyj karty review-required i luki usługowe z Wilkiem przed użyciem ich jako production-depth. |
| Workflow treści | `production` | `demo_ready` | 10 | 0 | 0 | 3 | 0 | 36 | Zacznij od istniejącej treści: zachowaj istniejący adres albo przygotuj odświeżenie/scalenie z dowodami. |
...
| Demand Gen | `experimental` | `review_ready` | 10 | 0 | 0 | 12 | 1 | 1 | Najpierw otwórz act_review_demand_gen_readiness i potwierdź, że WILQ widzi 0 kampanii Demand Gen/Discovery. Nie oceniaj jeszcze jakości kreacji ani ruchu, bo nie ma kampanii Dem... |
...
- Workflow treści `/content-workflow`: `ready` - REST=configured, WP-CLI=configured, ACF layouts=21, writes blocked=True
