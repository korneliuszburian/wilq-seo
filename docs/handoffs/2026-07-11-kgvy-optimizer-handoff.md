...
- Runtime po restarcie: `/api/health` `ok`; `/api/ads/diagnostics` zwraca
  `live_data_available=true`; `/api/metrics/status` raportuje 98 895 metric facts
  i 4 562 refresh runs.
- Browser proof po restarcie: `.local-lab/proof/ads-optimization-label-hydration.png`;
