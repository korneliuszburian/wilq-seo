...
- Runtime po restarcie: `/api/health` `ok`; `/api/ads/diagnostics` zwraca
  `live_data_available=true`; `/api/metrics/status` raportuje 98 885 metric facts
  i 4 557 refresh runs.
- Browser proof po restarcie: `.local-lab/proof/ads-decision-queue-assembly.png`;
