...
- Runtime po restarcie: `/api/health` `ok`; `/api/ads/diagnostics` zwraca
  `live_data_available=true`; `/api/metrics/status` raportuje 98 879 metric facts
  i 4 554 refresh runs.
- Browser proof po restarcie: `.local-lab/proof/ads-candidate-read-contracts.png`;
