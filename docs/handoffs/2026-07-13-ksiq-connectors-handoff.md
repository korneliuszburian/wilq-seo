...
- Dziewiąty pod-slice zakończony: `assert_ads_derived_kpi_contract_basics`
  ...
  row/evidence proof.
- Re-audit po dwudziestym szóstym pod-slice: 0 changed-code budget violations;
  główny test ma 2095 linii i 19 branchy. Branch budget jest zielony, line budget
  pozostaje otwarty.
