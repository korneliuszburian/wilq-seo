...
- Google Ads, Google Search Console, GA4, Google Sheets and both WordPress sites have first read-only `vendor_read` adapters that persist aggregate metrics/inventory only.
