...
| `/content-workflow` | 6/10 operator workflow; 5/10 real text quality; 8/10 handoff safety | Primary five-step "Treści i SEO" journey with persisted planning decisions and exact revisions. The active scope card shows page, service, intent, reader/problem, CTA and internal linking; the next card shows ordered sections, purpose and evidence count. The previous public/signals/dev/ACF wall is gone from marketer mode. | Existing queue/browser-safe snapshot and journey reads, exact planning review, revision save/review, exact Codex proposal, activation/readiness/readback and canonical ActionObject endpoints. Every new revision and WordPress binding carries the approved planning digest; legacy revisions are readable but blocked. Normal browser JSON has planning data and headings/readiness, not prompt/model input. | Save refetches the API-owned step; stale planning review preserves the note and offers explicit refresh. Section map cannot be approved before scope. Changed/reopened planning invalidates review, Codex child work, handoff and ActionObject without deleting history. Desktop/mobile live proof is `.local-lab/proof/dashboard-content-workflow/2026-07-15T23-08-03-347Z/`. | Service Profile remains review-required; typed Ads/keyword evidence, real measurement and verified internal links are missing. Real generated text remains 5/10 and the form has not had real Wilku UAT. | Add typed demand evidence under `amj2.3`; separately replace historical `CODEX_API_KEY` connector readiness and obtain owner-reviewed Service Profile/Wilku UAT. |
