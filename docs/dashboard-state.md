...
- Browser proof intercepts every ActionObject mutation and supplies a
  synthetic draft-only readback. No request reaches WordPress, no Codex runtime
  is called and no fallback path is added.
## Surface State
