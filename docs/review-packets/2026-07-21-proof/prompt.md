...
1. `desktop-1440x900.png` — pierwszy viewport desktopowy
2. `mobile-390x844.png` — pierwszy viewport mobilny
3. `desktop-full.png` — pełny, przewijany warsztat desktopowy
4. `mobile-full.png` — pełny, przewijany warsztat mobilny
5. `sources-open.png` — techniczny ekran źródeł po jawnym otwarciu
