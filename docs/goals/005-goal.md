...
4. Extend/use the implemented read-only Service Profile/review surface for
...
4. Service Profile read/review path is implemented from the current design and
   blocks direct ungated card editing.
