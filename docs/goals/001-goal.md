...
Last updated: 2026-06-23 08:08 CEST.
...
2026-06-23 Ads value snapshot follow-up: `/api/ads/diagnostics.operator_summary`
...
first `Ads snapshot marketera` section as `Snapshot wartości Ads`, before
