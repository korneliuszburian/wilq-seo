...
- `kgvy` reconciliation boundary jest domknięty: `_reconcile_ads_change_history_contracts`
  ...
  następny seam to summary/full response parity review.
- Reconciliation boundary jest domknięty przez
  ...
  summary/full response parity review, bez ponownego
...
- Managed API i dashboard są zdrowe. DuckDB ma 98 899 metric facts i 4 564
